...
## Project Structure
    ...
    ├── withered_block_dev_89062  # Django project configurations
...
1. Clone this repo and `cd withered_block_dev_89062`
...
2. Clone this repo and `cd withered_block_dev_89062`
