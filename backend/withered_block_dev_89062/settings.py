"""
Django settings for withered_block_dev_89062 project.
...
ROOT_URLCONF = 'withered_block_dev_89062.urls'
...
WSGI_APPLICATION = 'withered_block_dev_89062.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_block_dev_89062 API",
    "DESCRIPTION": "API documentation for withered_block_dev_89062 App",
    "VERSION": "v1",
}
